...
const DEMO_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=400&h=300&fit=crop&crop=center',
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1586985289688-ca3cf47d3e6e?w=400&h=300&fit=crop&crop=center',
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&h=300&fit=crop&crop=center',
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&h=300&fit=crop&crop=center',
...
function enrichStore(s: Store): Store {
  ...
  if (demoMatch) {
    return {
      ...s,
      logo_url: s.logo_url || demoMatch.logo_url,
      cover_image_url: s.cover_image_url || demoMatch.cover_image_url,
